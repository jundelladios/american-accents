...
class Update {
    ...
    private $required = ['colorhex', 'colorname', 'id'];

    private $nulls = ['colorhex', 'iscolorimage', 'colorimageurl', 'templates', 'isavailable', 'pantone', 'idea_galleries', 'vdsid', 'vdsproductid', 'image'];
