...
class Insert {
    ...
    private $required = ['product_line_id', 'collection_premium_backgrounds_id'];
    ...
    public function store( $request ) {
        ...
        try {
            ...
            $res = $this->updateOrPostHelper( new ProductLinePremiumBgModel, $data, ProductLinePremiumBgModel::query(), $this->allowedNulls );
