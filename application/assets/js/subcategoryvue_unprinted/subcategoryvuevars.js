var orderBy = [
    ...
    {
        value: "product_print_method.min_value DESC",
        text: "Highest to Lowest Price"
    },
    {
        value: "product_print_method.min_value ASC",
            ...
            <div class="row">
                ...
                <div class="mt-3 col-md-12 d-flex justify-content-between">
                    <ul class="f-breadcrumb list-unstyled d-flex m-0">
                        ...
                        <li><a :href="jsvars.baseURL + 'product/' + getApiRequest.cat_slug ">{{ getApiRequest.cat_name }}</a></li>
                        <li><span>{{getApiRequest.sub_name}}</span></li>
                    </ul>
                </div>
