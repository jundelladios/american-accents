        ...
        <div class="mt-5 container">
            <div class="row">
                <div class="col-md-12" style="">
                    <h5 class="mb-5">Search result for: {{queryParam}}</h5>
                </div>
            </div>
        </div>

        <div v-if="!queryParam" class="container">
            <div class="row">
                <div class="col-md-12" style="">
                    <p>There is no result in your search keyword.</p>
                </div>
            </div>
        </div>

        <div v-else class="container" id="topcategory">
            ...
            <div class="row mt-3">
                    ...
                    <div class="bg-grey p-4">
                        ...
                        <div v-else class="mb-5">
                            ...
                            <div class="row mt-3 ml-1">
                                <div v-for="(mpreloader, index) in 6" :key="'material-filter-preloader-' + index" class="col-4 pl-1 pr-1">
                        ...
                        <div class="aa-size-filter mb-4" v-if="filters.data.sizes.length > 1">
                            ...
                            <div class="row mt-3 ml-1">
                                <div v-for="(size, index) in filters.data.sizes" :key="'size-filter-' + index" class="col-4 pl-1 pr-1">
                                    <label class="checkbox-wrap">
                        ...
                        <div v-else class="mb-5">
                            <div class="skeleton grey mb-3" style="height: 20px; width: 30%;"></div>
                            <div class="row mt-3 ml-1">
                                <div v-for="(mpreloader, index) in 6" :key="'size-filter-preloader-' + index" class="col-4 pl-1 pr-1">
                                    <div class="skeleton grey mb-3" style="height: 20px;"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="aa-thickness-filter mb-4" v-if="filters.data.thickness.length > 1">
                            ...
                            <div class="row mt-3 ml-1">
                                <div v-for="(thick, index) in filters.data.thickness" :key="'thick-filter-' + index" class="col-4 pl-1 pr-1">
                                    <label class="checkbox-wrap">
                        ...
                        <div v-else class="mb-5">
                            <div class="skeleton grey mb-3" style="height: 20px; width: 30%;"></div>
                            <div class="row mt-3 ml-1">
                                <div v-for="(mpreloader, index) in 6" :key="'thickness-filter-preloader-' + index" class="col-4 pl-1 pr-1">
                                    <div class="skeleton grey mb-3" style="height: 20px;"></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div v-if="!filters.loading && !products.loading && !getProductsIterate.length" class="row">
                        <div class="col-md-12">
                            <div class="pt-5 pb-5">
                                <p class="text-center">There is no result in your search keyword.</p>
                            </div>
                        </div>
                    </div>
