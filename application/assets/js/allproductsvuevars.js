                ...
                <div class="col-md-12 mb-4 mt-1 category-filter-sort">
                    <div class="row">
                        <div class="col-sm-3 filters-material">
                            ...
                            <span v-if="selectedCategoryData">
                                <span 
                                class="filter-badge">{{selectedCategoryData.cat_name}} <span @click="selectedCategory=null" class="icon icon-close-circle"></span>
                                </span>
                            </span>
            ...
            <div class="row mt-3">
                ...
                <div :class="\`col-lg-3 col-md-5 filter-sidebar \${openFilter ? 'show' : ''}\`">
                    <div class="bg-grey p-4">
                        ...
                        <div class="aa-cat-filter mb-5" v-if="filters.data.categories.length > 1">
                            <span class="text-uppercase font-weight-bold f-cat-filter-color">categories:</span>
                            <ul class="list-unstyled mt-3 ml-2">
                                <li v-for="(cat, index) in filters.data.categories" :key="'subcategory-filters-' + index">
                                    <label class="checkbox-wrap">
                                        <span class="font-small f-cat-filter-color">{{ cat.cat_name }}</span>
                                        <input type="radio" v-model="selectedCategory" :value="cat.cat_slug">
                                        <span class="checkmark"></span>
                                    </label>
                                </li>
                            </ul>
